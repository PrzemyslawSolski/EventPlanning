            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        <label>Miejsce:</label>
                        <form:input path="name" name="place" placeholder="np. kościół NMP" id="formVenueName"
                                    class="form-control"/>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <form:input path="city" type="text" name="city" placeholder="np. Pcim" id="formEventCity"
                                    class="form-control"/>
                        <form:errors path="city" element="div" cssClass="error"></form:errors>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Kod pocztowy:</label>
                        <form:input path="zip" name="zip" pattern="^[0-9]{2}-[0-9]{3}$"
                                    oninput="if(this.value.length==2 && this.value.indexOf('-')==-1) this.value+='-';"
                                    placeholder="np. 02-345" id="formEventZip" class="form-control"/>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <form:input path="street" name="street" placeholder="np. Grochowska" id="formVenueStreet"
                                    class="form-control"/>
                        <form:errors path="street" element="div" cssClass="error"></form:errors>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="formVenueNumber">Numer:</label>
                        <form:input path="number" name="number" placeholder="np. 3 lub 34/16" id="formVenueNumber"
                                    class="form-control"/>
