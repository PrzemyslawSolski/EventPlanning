    ...
    <form id="edit-form">
        ...
        <div class="row">
            <div class="form-group col-md-5">
                <label>Imię:</label>
                <input type="text" placeholder="imię" id="formName" class="form-control">
            </div>
<%--        </div>--%>
...
<%--        <div class="row">--%>
            <div class="form-group col-md-5">
                ...
                <input type="text" placeholder="nazwisko" id="formSurname" class="form-control">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-10">
...
<%--        <div class="row">--%>
            <div class="form-group col-md-5">
                ...
                <input type="password" placeholder="powtórz hasło" id="formPasswordConfirm" class="form-control">
            </div>
        </div>
